...
void ServerDatabase::updateDatabaseSchema() {
	...
	alterDatabase(1002,
		...
		",`session_seconds` bigint(11) unsigned NOT NULL"
		",`delta_seconds` bigint(11) unsigned NOT NULL"
		",`delta_credits` bigint(11) NOT NULL"
		",`delta_skillpoints` int(3) NOT NULL"
		",`activity_xp` int(10) unsigned NOT NULL"
		",`activity_movement` int(5) unsigned NOT NULL"
		",`current_credits` bigint(11) NOT NULL"
