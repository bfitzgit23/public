...
CreatureTemplateManager::CreatureTemplateManager() : Logger("CreatureTemplateManager") {
	...
	//Infinity: Custom creature flags
	lua->setGlobalInt("NODIZZY", CreatureFlag::NODIZZY);
	lua->setGlobalInt("NOKNOCKDOWN", CreatureFlag::NOKNOCKDOWN);
	lua->setGlobalInt("NOPOSTUREDOWN", CreatureFlag::NOPOSTUREDOWN);
	lua->setGlobalInt("NOBLIND", CreatureFlag::NOBLIND);
	lua->setGlobalInt("NOSTUN", CreatureFlag::NOSTUN);
	lua->setGlobalInt("BABYONLY", CreatureFlag::BABYONLY);
	lua->setGlobalInt("ADULTONLY", CreatureFlag::ADULTONLY);
