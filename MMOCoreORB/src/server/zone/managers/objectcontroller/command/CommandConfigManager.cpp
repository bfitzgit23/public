...
void CommandConfigManager::registerCommands() {
	...
	commandFactory.registerCommand<CityStatusCommand>(String("citystatus").toLowerCase());
	commandFactory.registerCommand<DashCommand>(String("dash").toLowerCase());
	commandFactory.registerCommand<FindDecoCommand>(String("finddeco").toLowerCase());
	...
	commandFactory.registerCommand<GmScreenplaysCommand>(String("gmScreenplays").toLowerCase());
	...
	commandFactory.registerCommand<SetBountyCommand>(String("SetBounty").toLowerCase());
	...
	//Infinity:  Removed all references to Core3 FRS modifiers
}
