...
public:
	...
	int getVector3TableSize() {
		return vector3Table.size();
	}

	int getStringVectorTableSize() {
		return stringVectorTable.size();
	}

	int getSize() {
		return hashTable.size() + stringTable.size() + vector3Table.size() + stringVectorTable.size();
	}
