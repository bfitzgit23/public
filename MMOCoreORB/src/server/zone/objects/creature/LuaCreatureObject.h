...
namespace creature {
	...
	public:
		...
		int isHarvesterDroidPet(lua_State* L);
		int isInCamp(lua_State* L);
		int isSwimming(lua_State* L);
		int isCityBanned(lua_State* L);
		int failPlayerBountyMission(lua_State* L);
		int createAttachment(lua_State* L);
		int setSpeedBuff(lua_State* L);
		int setRootedState(lua_State* L);
		int setSnaredState(lua_State* L);
		int removeSpeedBuffs(lua_State* L);
		int getSkillsHash(lua_State* L);
		int surrenderAllSkills(lua_State* L);
		int ejectPlayerFromBuilding(lua_State* L);
        int addSkillModifierBuff(lua_State* L);
        int addAttributeModifierBuff(lua_State* L);
