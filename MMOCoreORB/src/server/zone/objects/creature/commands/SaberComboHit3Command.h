...
#ifndef SABERCOMBOHIT3COMMAND_H_
#define SABERCOMBOHIT3COMMAND_H_

#include "JediCombatQueueCommand.h"

class SaberComboHit3Command : public JediCombatQueueCommand {
public:

	SaberComboHit3Command(const String& name, ZoneProcessServer* server)
...
#endif //SABERCOMBOHIT3COMMAND_H_
