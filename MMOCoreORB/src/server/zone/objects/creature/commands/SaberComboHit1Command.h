...
#ifndef SABERCOMBOHIT1COMMAND_H_
#define SABERCOMBOHIT1COMMAND_H_

#include "JediCombatQueueCommand.h"

class SaberComboHit1Command : public JediCombatQueueCommand {
public:

	SaberComboHit1Command(const String& name, ZoneProcessServer* server)
...
#endif //SABERCOMBOHIT1COMMAND_H_
