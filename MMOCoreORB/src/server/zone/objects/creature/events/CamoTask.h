...
public:
	...
	void run() {
		...
		if (!success) {
			...
			int timer = (13.0f - (playerCreo->getSkillMod("mask_scent") / 10.0f)) * 1000;	//Infinity:  Cooldown Timer based on mask_scent skill, reduced cooldown timer which was punitive
