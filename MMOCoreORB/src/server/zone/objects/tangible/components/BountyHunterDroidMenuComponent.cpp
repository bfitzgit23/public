...
bool BountyHunterDroidMenuComponent::playerCanUseTrack(CreatureObject* player) const {
	return player->hasSkill("combat_bountyhunter_investigation_03") || player->hasSkill("mandalorian_master");
}

bool BountyHunterDroidMenuComponent::playerCanUseDroids(CreatureObject* player) const {
	return player->hasSkill("combat_bountyhunter_investigation_01") || player->hasSkill("mandalorian_master");
}
