...
bool FactoryObjectImplementation::startFactory() {
	...
	timer = ((int)schematic->getComplexity()) * 2;   //Infinity:   Reduced from EMU standard of complexity * 8.   This is default live value.

	//Infinity:  Instant factories on test servers
