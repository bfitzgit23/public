...
namespace scene {
	...
	public:
		...
		int rotateReset(lua_State* L);
		int rotate(lua_State* L);
		int rotateRoll(lua_State* L);
		int rotatePitch(lua_State* L);
		int getDirectionX(lua_State* L);
		int getDirectionY(lua_State* L);
		int getDirectionZ(lua_State* L);
		int getDirectionW(lua_State* L);
		int setDirection(lua_State* L);
		int extractObjectToInventory(lua_State* L);
		int isFactoryCrate(lua_State* L);
		int isArmorObject(lua_State* L);
		int isWeaponObject(lua_State* L);
		int getPrototypeTemplatePath(lua_State* L);
		int isVendorObject(lua_State* L);
        int getNPCsInRange(lua_State* L);
        int getTemplateObjectFilename(lua_State* L);
		int isPetControlDevice(lua_State* L);
		...
		int getRootParentID(lua_State* L);
		int isCellObject(lua_State* L);
		int isTangibleObject(lua_State* L);
		int isIntangibleObject(lua_State* L);
