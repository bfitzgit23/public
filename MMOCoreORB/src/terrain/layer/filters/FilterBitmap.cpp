...
*/
	...
	// Infinity:  TienVogh fix for Kash bitmaps with height
	...
	float mapResult = v31 * (1.0 - v30) * (long double)arg6 * 0.003921568859368563 + v31 * v30 * (long double)arg1 * 0.003921568859368563 + (1.0 - v31) * (1.0 - v30) * (long double)v28 * 0.003921568859368563 + (1.0 - v31) * v30 * (long double)arg2 * 0.003921568859368563;
	if (mapResult == 1.0)
