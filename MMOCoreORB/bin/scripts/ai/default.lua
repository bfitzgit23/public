...
attackDefault = {
	...
	{id="3316246651",	name="WriteBlackboard",	pid="2812006626",	args={key="attackType", val=DEFAULT}},
	{id="1932903383",	name="WriteBlackboard",	pid="2812006626",	args={key="attackType", val=RANDOM}},
	{id="2322819263",	name="WriteBlackboard",	pid="2812006626",	args={key="attackType", val=RANDOM}},
