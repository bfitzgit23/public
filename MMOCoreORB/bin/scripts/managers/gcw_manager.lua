...
crackdownPlanetsWithWildScans = { "corellia", "dantooine", "dathomir", "endor", "lok", "naboo", "rori", "talus", "tatooine", "yavin4", "kashyyyk"}
...
imperial_racial_penalty = {
	{0, 1.0},	-- default includes humans, no penalty.  2% penalty for all ugly aliens.
	{1, 1.02}, 	-- Rodian
	{2, 1.02}, 	-- Trandoshan
	{3, 1.02}, 	-- Moncal
	{4, 1.02}, 	-- Wookiee
