...
playerBountyKillBuffer = 0 -- Infinity:   30 * 60 * 1000 -- Buffer before player bounty can be put back on terminal after target is killed, set 0 to disable

playerBountyDebuffLength = 0 -- Infinity:   3 * 24 * 60 * 60 * 1000 -- Time before their bounty resets from the minimum amount
...
destroyMissionRandomReward = 0 -- Not used
destroyMissionGroupRewardFactor = 15 -- 