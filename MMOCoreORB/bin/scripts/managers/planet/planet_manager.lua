...
-- Infinity:  No wait times, shuttle stays *landed* for 24 hours
...
corellia = {
	...
	planetTravelPoints = {
		...
		{name = "Vreni Island Shuttle", x = -5551.9473, z = 15.5396, y = -6059.9673, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		...
		{name = "Kor Vella Shuttleport", x = -3775.2546, z = 86, y = 3234.2202, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3}, --Infinity
		...
		{name = "Doaba Guerfel Shuttleport", x =  3084.17, z = 280, y = 4997.75, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 2.5},
		...
		{name = "Bela Vistal Shuttleport B", x = 6928.19, z = 330, y = -5534.8936, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},  --Infinity:  Adjusted
	},

	badgeAreas = {
		{"badge_agrilat_swamp",1387,3749,0,30,20},
		...
		-- Infinity Exploration Badges
		{"badge_beach_hut",7477,-1775,0,30,148},
		{"badge_mysterious_monument",-1909,3986,0,30,149},
		{"badge_destroyed_outpost",1900,-229,0,30,150},
	},
	...
	planetObjects = {
		-- Infinity:  New Player Terminals
		{templateFile = "object/tangible/terminal/terminal_new_player_services.iff", ox = 0, oy = 0.998269, oz = 0, ow = -0.058822, x = -136.867, z = 28, y = -4733.99, parentid = 0},  -- Coronet Starport New Player Terminal
...
dantooine = {
	...
	badgeAreas = {
		...
		-- Infinity Exploration Badges
		{"badge_techno_idol",-2787,5673,0,30,151},
		{"badge_face_worship",6070,-6466,0,30,152},
		{"badge_stargate_sg1",-2990,122,0,30,153},
	},
...
dathomir = {
	...
	badgeAreas = {
		...
		-- Infinity Exploration Badges
		{"badge_clan_village",-7083,5828,0,30,154},
		{"badge_slave_camp",7212,5562,0,30,155},
		{"badge_dest_reb_base",-4729,-4773,0,30,156},
	},
...
endor = {
	...
	badgeAreas = {
		...
		-- Infinity Exploration Badges
		{"badge_dest_imp_base",2324,5860,0,30,157},
		{"badge_korga_hut",-1800,6025,0,30,158},
		{"badge_shaman_hut",4030,-7663,0,30,159},
	},
...
etyyy = {
	...
	outpostRegionNames = {
		{name = "@etyyy_region_names:outpost_main", x = 272, y = 502},
		{name = "@etyyy_region_names:outpost_rodian", x = 559, y = 533},
		{name = "@etyyy_region_names:outpost_arcona", x = -597, y = 873},
		{name = "@etyyy_region_names:outpost_blackscale", x = 39, y = -490},
		{name = "@etyyy_region_names:outpost_chiss", x = -1211, y = -115},
		{name = "@etyyy_region_names:outpost_bandit", x = 36, y = -192},
	},
	--[[
	...
	navAreas = {
		{"outpost_main",272, 502,250},
		{"outpost_rodian",559, 533,128},
		{"outpost_arcona",-597, 873,128},
		{"outpost_bandit",39, -490,128},
		{"outpost_chiss",-1211, -115,128},
		{"outpost_blackscale",36, -192,128},
	},
}
...
hoth = {
	...
	outpostRegionNames = {
		{name = "@hoth:hothstarport", x = 0, y = -2000},
	},
	
	navAreas = {
		{"caves_area",-563, 2200,1024},
	},
}
...
kashyyyk = {
	...
	--]]
	planetTravelPoints = {
		{name = "Azure Veil Mine", x = -2899, z = 16, y = -2202, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1, landingRange = 3},
		{name = "Krsss-Forak", x = 7389, z = 4, y = -4617, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1, landingRange = 3},
		{name = "Wawaatt", x = 3250, z = 2, y = 956, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1, landingRange = 3},
	},
	--[[
	badgeAreas = {
	...
	navAreas = {
		{"krsss_forak",6468,-5349,396},
		{"azure_veil_mine",-2950,-2250,256},
	},
	--[[
	planetObjects = {
...
lok = {
	...
	planetTravelPoints = {
		...
		{name = "Infinity Arena", x = 685, z = 12, y = 2160, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1, landingRange = 3},
	},
	...
	badgeAreas = {
		...
		{"badge_volcano",3091,-4638,0,10,24},
		-- Infinity Exploration Badges
		{"badge_marm_shroom",420,69,0,30,160},
		{"badge_myst_grave",-3813,5304,0,30,161},
		{"badge_rit_site",5068,405,0,30,162},
	},
...
naboo = {
	...
	badgeAreas = {
		...
		-- Infinity Exploration Badges
		{"badge_gungan_ruin",7590,6948,0,30,163},
		{"badge_fish_spot",-6314,-5090,0,30,164},
		{"badge_gungan_temple",-236,2893,0,30,165},
	},
	...
	navAreas = {
		...
		{"weapon_development_facility",-6505,-3310,96},
	},
...
rori = {
	...
	planetTravelPoints = {
		{name = "Restuss Starport", x = 5340, z = 80, y = 5734, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		{name = "Restuss Shuttleport", x = 5211, z = 80, y = 5791, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		{name = "Narmle Starport", x = -5374.0718, z = 80, y = -2188.6143, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		...
		{name = "Battleground Staging: Rebellion", x = -3394, z = 76, y = -6905, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1, landingRange = 3},
		{name = "Battleground Staging: Imperial Army", x = -3315, z = 75, y = -7056, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1, landingRange = 3},
	},
	...
	badgeAreas = {
		...
		-- Infinity Exploration Badges
		{"badge_rorgun_ruin",-5791,5842,0,30,166},
		{"badge_imp_out",6538,-4742,0,30,167},
		{"badge_commander_estate",5208,1020,0,30,168},
	},
...
talus = {
	...
	planetTravelPoints = {
		...
		{name = "Talus Imperial Outpost", x = -2228, z = 20, y = 2321.9, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 2},  -- Infinity
	...
	badgeAreas = {
		...
		-- Infinity Exploration Badges
		{"badge_diseased_ruins",-5117,3270,0,30,169},
		{"badge_chunker_bunker",1373,1440,0,30,170},
		{"badge_aqua_house",0,-905,0,30,171},
	},
...
tatooine = {
	...
	badgeAreas = {
		...
		-- Infinity Exploration Badges
		{"badge_the_oasis",6257,-438,0,30,172},
		{"badge_jawa_vs_tusken",5778,3983,0,30,173},
		{"badge_dest_imp_bunker",-1490,-208,0,30,174},
	},
...
yavin4 = {
	...
	badgeAreas = {
		...
		-- Infinity Exploration Badges
		{"badge_myst_ruins",-2720,-170,0,30,175},
		{"badge_remote_reb_camp",1600,1530,0,30,176},
		{"badge_sealed_bunker",-7108,4381,0,30,177},
	},
