imperial_surface_marshal = Creature:new {
	...
	primaryAttacks = merge(riflemanmid,carbineermid,brawlermaster,marksmanmaster,pikemanmaster),
	secondaryAttacks = { }
}

CreatureTemplates:addCreatureTemplate(imperial_surface_marshal, "imperial_surface_marshal")
