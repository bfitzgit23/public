gcw_rebel_operative = Creature:new {
	customName = "Verena Talos (a Rebel Operative)",
	faction = "rebel",
	socialGroup = "rebel",
	mobType = MOB_NPC,
	level = 400,
	...
	templates = {"object/mobile/dressed_rebel_staff_corporal_human_female_01.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(gcw_rebel_operative, "gcw_rebel_operative")
