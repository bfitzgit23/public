...
--npc jedi skills
lightsabermaster = { {"saberheadhit1",""},{"saberheadhit2",""},{"saber1hhit3",""},{"sabercombohit3",""},{"saber1hflurry",""},{"saber1hflurry2",""},{"saberbodyhit2",""},
				{"saberbodyhit3",""},{"saber2hfrenzy",""},{"saber2hhit3",""},{"saber2hphantom",""},{"sabersweep3",""},{"saberpolearmdervish",""},{"saberpolearmdervish2",""},
				{"saberpolearmhit3",""},{"saberleghit3",""},{"saberspinattack3",""},{"saberslash1",""},{"saberslash2",""},{"saberthrow2",""} }
...
-- Infinity
rifleingletarget = { {"headshot3",""},{"mindshot2",""} }
pistolsingletarget = { {"healthshot2",""},{"pointblanksingle2",""},{"bodyshot3",""} }
carbsingletarget = {{"actionshot2",""},{"fullautosingle2",""},{"legshot3",""},{"cripplingshot",""}}

fencersingletarget = { {"melee1hhit3",""},{"melee1hscatterhit2",""},{"melee1hdizzyhit2",""}, {"melee1hbodyhit2",""},{"melee1hhealthhit2",""},{"melee1hblindhit2",""} }
swordsingletarget = { {"melee2hhit3",""},{"melee2hmindhit2",""},{"melee2hheadhit3",""} }
pikesingletarget = { {"polearmactionhit2",""},{"polearmstun2",""},{"polearmhit3",""},{"polearmleghit3",""},{"polearmstun2",""} }
tkasingletarget = { {"unarmedhit3",""},{"unarmedleghit1",""},{"unarmedbodyhit1",""},{"unarmedheadhit1",""},{"unarmedknockdown2",""},{"unarmeddizzy1",""} }

-- Boss specials
pogglespecial = { {"intimidationattack","stateAccuracyBonus=65"}, {"creatureareableeding",""} }
chissboss = { {"creatureareacombo","stateAccuracyBonus=100"}, {"creatureareaknockdown","stateAccuracyBonus=100"} }