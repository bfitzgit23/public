...
reset1 = ConvoScreen:new {
	id = "reset1",
	customDialogText = "In order to reset I must take your ring back",
	stopConversation = "false",
	options = {
		{"Yes, I understand", "reset2"}, -- I am well. Just seeing how the old man is.
	}
}
heroOfTatHermitConvoTemplate:addScreen(reset1);

reset2 = ConvoScreen:new {
	id = "reset2",
	customDialogText = "The deal is done, you are no longer the Hero of Tatooine...",
	stopConversation = "true",
	options = {	}
}
heroOfTatHermitConvoTemplate:addScreen(reset2);
