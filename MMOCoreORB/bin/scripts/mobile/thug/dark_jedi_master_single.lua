dark_jedi_master_single = Creature:new {
	...
	defaultWeapon = "object/weapon/melee/2h_sword/crafted_saber/sword_lightsaber_two_handed_gen4_ranged.iff",
	defaultAttack = "forcelightningsingle2"
}

CreatureTemplates:addCreatureTemplate(dark_jedi_master_single, "dark_jedi_master_single")
