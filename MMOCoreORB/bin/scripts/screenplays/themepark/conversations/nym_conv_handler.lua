...
function NymConvoHandler:runNymScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif (screenID == "go_lab") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Imperial Research Facility", "Imperial Research Facility", ThemeParkNym.waypointMap.researchfacility.x, ThemeParkNym.waypointMap.researchfacility.y, WAYPOINTPURPLE, true, true, 0)
	...
	elseif (screenID == "go_to_officer") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Nym's Informant", "Nym's Informant", ThemeParkNym.waypointMap.gambler.x, ThemeParkNym.waypointMap.gambler.y, WAYPOINTPURPLE, true, true, 0)
...
function NymConvoHandler:runJinkinsScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	if (screenID == "heres_droid_memory") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Sulfur Lake Pirate Hideout", "", ThemeParkNym.waypointMap.piratecave.x, ThemeParkNym.waypointMap.piratecave.y, WAYPOINTPURPLE, true, true, 0)
	...
	elseif (screenID == "heres_the_guy") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Hermit", "", ThemeParkNym.waypointMap.choster.x, ThemeParkNym.waypointMap.choster.y, WAYPOINTPURPLE, true, true, 0)
...
function NymConvoHandler:runKoleScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif (screenID == "here_is_gas") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Imperial Gas Mine", "", ThemeParkNym.waypointMap.gasmine.x, ThemeParkNym.waypointMap.gasmine.y, WAYPOINTPURPLE, true, true, 0)
	...
	elseif (screenID == "here_is_imperial") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Sergeant Moore", "", ThemeParkNym.waypointMap.imperialbribe.x, ThemeParkNym.waypointMap.imperialbribe.y, WAYPOINTPURPLE, true, true, 0)
...
function NymConvoHandler:cellPlayerPermissionsObserver(pCreature,pCreature2)
	if pCreature ~= nil and SceneObject(pCreature):isCreatureObject() then
