...
VillageJediManagerTownship = ScreenPlay:new {
	...
	phaseChangeTimeOfDay = { hour = 14, min = 0 }, -- Hour of day, server military time, to change the phase. Comment out to disable

	VILLAGE_PHASE_DURATION = 3 * 24 * 60 * 60 * 1000 --3 * 7 * 24 * 60 * 60 * 1000 -- 3 weeks
}
