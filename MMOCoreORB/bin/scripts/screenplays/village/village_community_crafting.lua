		...
		if #statTable ~= 0 then
			...
			if (pQualityWinner ~= nil) then
				...
				if pInventory ~= nil then
					...
					if pItem ~= nil and pItem then
						printLuaLog("Village Crafting phase " .. currentPhase .. " qualityWinner for ingredient #" .. i .. " [" .. CreatureObject(pQualityWinner):getFirstName() .. "]: 5 use Crafting tool delivered")
					else
						printLuaLog("Village Crafting phase " .. currentPhase .. " qualityWinner for ingredient #" .. i .. " [" .. CreatureObject(pQualityWinner):getFirstName() .. "]: 5 use Crafting tool FAILURE")
					end
				end
			end
			...
			if (pQuantityWinner ~= nil) then
				...
				if pInventory ~= nil then
					...
					if pItem ~= nil and pItem then
						printLuaLog("Village Crafting phase " .. currentPhase .. " quantityWinner for ingredient #" .. i .. " [" .. CreatureObject(pQuantityWinner):getFirstName() .. "]: 5 use Crafting tool delivered")
					else
						printLuaLog("Village Crafting phase " .. currentPhase .. " quantityWinner for ingredient #" .. i .. " [" .. CreatureObject(pQuantityWinner):getFirstName() .. "]: 5 use Crafting tool FAILURE")
					end
				end
			end
		end
	...
	if (#overallQuality > 0) then
		...
		if (pQualityWinner ~= nil) then
			...
			if pInventory ~= nil then
				...
				if pItem ~= nil and pItem then
					printLuaLog("Village Crafting phase " .. currentPhase .. " overall qualityWinner [" .. CreatureObject(pQualityWinner):getFirstName() .. "]: 20 use Crafting tool delivered")
				else
					printLuaLog("Village Crafting phase " .. currentPhase .. " overall qualityWinner [" .. CreatureObject(pQualityWinner):getFirstName() .. "]: 20 use Crafting tool FAILURE")
				end
			end
		end
	end
	...
	if (#overallQuantity > 0) then
		...
		if (pQuantityWinner ~= nil) then
			...
			if pInventory ~= nil then
				...
				if pItem ~= nil and pItem then
					printLuaLog("Village Crafting phase " .. currentPhase .. " overall quantityWinner [" .. CreatureObject(pQuantityWinner):getFirstName() .. "]: 20 use Crafting tool delivered")
				else
					printLuaLog("Village Crafting phase " .. currentPhase .. " overall quantityWinner [" .. CreatureObject(pQuantityWinner):getFirstName() .. "]: 20 use Crafting tool FAILURE")
				end
			end
		end
	end
