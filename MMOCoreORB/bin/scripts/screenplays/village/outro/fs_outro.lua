...
FsOutro = ScreenPlay:new {
	...
	stepDelay = {
		[1] = { 1200, 23200  }, -- 15600, 86400 Old man visit, 1 hour to 1 day
	}
}
...
function FsOutro:isOnOutro(pPlayer)
	return VillageJediManagerCommon.hasJediProgressionScreenPlayState(pPlayer, VILLAGE_JEDI_PROGRESSION_COMPLETED_VILLAGE) and not VillageJediManagerCommon.hasJediProgressionScreenPlayState(pPlayer, VILLAGE_JEDI_PROGRESSION_DEFEATED_MELLICHAE)
end
...
function FsOutro:completeVillageOutroFrog(pPlayer)
	...
	VillageJediManagerCommon.setJediProgressionScreenPlayState(pPlayer, VILLAGE_JEDI_PROGRESSION_DEFEATED_MELLICHAE)
