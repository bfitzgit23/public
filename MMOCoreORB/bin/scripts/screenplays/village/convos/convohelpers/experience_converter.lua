...
function ExperienceConverter:convertXpTransferCallback(pPlayer, pSui, eventIndex, transferInputFromValue, transferInputToValue)
	...
	xpToConvert = math.floor(xpToConvert)
	CreatureObject(pPlayer):awardExperience(chosenXp, xpToConvert * -1, false, false) -- Don't use XP modifiers
	...
	CreatureObject(pPlayer):awardExperience("fs_" .. conversionType, convertedXp, false, false) -- Don't use XP modifiers
