...
function JediTrials:unlockJediPadawan(pPlayer, dontSendSui)
    ...
    VillageJediManagerCommon.setJediProgressionScreenPlayState(pPlayer, VILLAGE_JEDI_PROGRESSION_COMPLETED_PADAWAN_TRIALS) -- Update the state which gets checked later 
