...
corvetteRebelSpawns = {
	...
	-- mandalorian spawn
	{ "vette_r5_imperial", 7, -6.7, -41.1, -39, "thrustersubroom27", "" },
...
corvetteImperialSpawns = {
	...
	-- mandalorian spawn: vette_r5_rebel
	{ "vette_r5_rebel", 7, -6.7, -41.1, -39, "thrustersubroom27", "" },
...
corvetteNeutralSpawns = {
	...
	-- mandalorian spawn: vette_r5_neutral
	{ "vette_r5_neutral", 7, -6.7, -41.1, -39, "thrustersubroom27", "" },
