...
function EndorDulokVillageNorthScreenPlay:start()
	if (isZoneEnabled(self.planet)) then
		...
		createEvent(delay * 60 * 1000, "EndorDulokVillageNorthScreenPlay","clearPatrolPoints", nil , "")
	end
end
...
function EndorDulokVillageNorthScreenPlay:clearPatrolPoints()

	local creatureTable = getCreaturesInRangeOfPos("endor", -1207, 2964, 96)
