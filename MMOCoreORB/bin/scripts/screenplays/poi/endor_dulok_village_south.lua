...
function EndorDulokVillageSouthScreenPlay:start()
	if (isZoneEnabled(self.planet)) then
		...
		createEvent(delay * 60 * 1000, "EndorDulokVillageSouthScreenPlay","clearPatrolPoints", nil , "")
	end
end
...
function EndorDulokVillageSouthScreenPlay:clearPatrolPoints()

	local creatureTable = getCreaturesInRangeOfPos("endor", 6066, -2473, 96)
