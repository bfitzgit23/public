...
function GoToTheater:spawnTheaterObjects(pPlayer)
	...
	if pPlayer == nil then
		printLuaError("GoToTheater:spawnTheaterObjects for " .. self.taskName .. ", pPlayer object null.")
		return
	end
...
function GoToTheater:setupActiveArea(pPlayer, spawnPoint)
    ...
    if pPlayer == nil or spawnPoint == nil then
        return false
    end
...
function GoToTheater:handleEnteredAreaEvent(pActiveArea, pPlayer)
