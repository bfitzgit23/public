	...
	lootGroups = {
		{
			...
			lootChance = 80 * (100000)
		},
		{
			groups = {
				{group = "city_highgarden_cantina", chance = 10000000}
			},
			lootChance = 75 * (100000)
		},
		{
			groups = {
				{group = "egg_group_04", chance = 10000000}
			},
			lootChance = 15 * (100000)
		},
		{
			groups = {
				{group = "incubator_schematics1", 	chance = 50 * (100000)},
				{group = "incubator_schematics2", 	chance = 50 * (100000)},
			},
			lootChance = 5 * (100000),
		},
	},
...
function NarglatchCaveScreenPlay:spawnMobiles()
	...
	spawnMobile("naboo", "narglatch_matriarch", 2700,  190.2, -66, -101.4, 100, 5285903)
