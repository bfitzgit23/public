NabooTheedScreenPlay = CityScreenPlay:new {
	...
	mobiles = {
		...
		{"trainer_architect",0,11,1.1,-14.9,0,1692093, ""},
		{"trainer_armorsmith", 0, -12.7, 1.1, -0.7, 178, 1692092, ""},
		{"trainer_weaponsmith", 0, -3.4, 1.1, -8.2, 132, 1692094, ""},
		...
		{"trainer_merchant",0,13.4,1.1,5.8,163,1692091, ""},
		{"trainer_droidengineer",0,-11.4,1.1,-14.5,0,1692095, ""},
