...
function JunkDealerConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif screenID == "ask_for_quest" then
		if util:hasQuestState(pPlayer, "highgardenHotelBonus", 64) or util:hasQuestState(pPlayer, "highgardenHotelBonus", 128) then
			if not util:hasQuestState(pPlayer, "highgardenHotelNado", 1) then
				clonedScreen:addOption("I heard you give out rare paintings, is that true?", "prize")
			end
		end
	elseif screenID == "where_nedo" then
		infiniteLLCQuest1:addWaypoint(pPlayer, "Go see Nedo", "tatooine", 3789, 2377)
	elseif screenID == "prize" then
		local prizes = {
			"object/tangible/painting/hotelreward_05_f07_00000000000.iff",
			"object/tangible/painting/hotelreward_05_f02_00000000000.iff",
			"object/tangible/painting/hotelreward_05_f05_00000000000.iff",
			"object/tangible/painting/hotelreward_05_f02_00000000000.iff",
			"object/tangible/painting/hotelreward_05_f05_00000000000.iff",
			"object/tangible/painting/hotelreward_05_f02_00000000000.iff",
			"object/tangible/painting/hotelreward_05_f05_00000000000.iff",
		}
		util:giveQuestReward(pPlayer, prizes[getRandomNumber(#prizes)])
		util:setQuestState(pPlayer, "highgardenHotelNado", 1)
