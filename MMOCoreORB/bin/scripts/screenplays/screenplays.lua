...
-- Infinity custom version of geo_lab in custom folder
...
--[[
Infinity custom handlers are used
...
-- Infinity - replaced for varactyl quest
...
-- POIs
-- Infinity Rogue Corsec replaced with Chiss
...
-- Infinity customized this with a new cave
...
-- includeFile("static_spawns/tatooine_static_spawns_south.lua")  -- Infinity:  Moved to custom
...
--Battlefields
-- includeFile("battlefields/battlefield_spawner.lua");   --Infinity: Disabled for now
...
-- Infinity Additions
includeFile("custom_content/tools/buff_bot.lua")
includeFile("custom_content/tools/buffBotConvoHandler.lua")
includeFile("custom_content/tools/login_skill_check.lua")
includeFile("custom_content/tools/medical_bot.lua")
includeFile("custom_content/tools/medicalBotConvoHandler.lua")
includeFile("custom_content/tools/mission_direction_choice.lua")
includeFile("custom_content/tools/mission_level_choice.lua")
includeFile("custom_content/tools/buff_bot.lua")

includeFile("custom_content/dungeon/warren/captain_heff_convo_handler.lua")
