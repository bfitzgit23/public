...
function TatooineStaticSpawnsNorthScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "pearl_hunter", getRandomNumber(7200, 14400), -6196.52, 30.9447, 5020.56, 0, 0)    --Infinity:  Let's whack the AFKers
	...
	spawnMobile("tatooine", "pearl_hunter", getRandomNumber(7200, 14400), 5711.7, 55.7451, 3749.94, 0, 0)    --Infinity:  Let's whack the AFKers
	...
	spawnMobile("tatooine", "pearl_hunter_marauder", getRandomNumber(7200, 14400), -6758.87, 174.347, 3504.38, 0, 0)  --Infinity:  Let's whack the AFKers
	...
	local pNpc = spawnMobile("tatooine", "weequay_captain", 300, -5.4, 0.4, -3.2, -141, 1154022)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "weequay_captain", 300, -4.9, 0.4, -5.1, -78, 1154022)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "weequay_captain", 300, -6.6, 0.4, -5.4, 36, 1154022)
