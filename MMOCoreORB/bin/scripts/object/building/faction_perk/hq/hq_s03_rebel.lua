...
object_building_faction_perk_hq_hq_s03_rebel = object_building_faction_perk_hq_shared_hq_s03_rebel:new {
	...
	--planetMapSubCategory = "rebel_major_base",
	alwaysPublic = 1,
	factionBaseType = 1,
	...
	childObjects = {
		...
		{ templateFile = "object/installation/faction_perk/turret/tower_lg.iff", x = -14.25, z = 0, y = 25, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1 },
        { templateFile = "object/installation/faction_perk/turret/tower_lg.iff", x = 14.25, z = 0, y = 25, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1 },
		{ templateFile = "object/installation/faction_perk/turret/tower_lg.iff", x = -18.25, z = 0, y = -12, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1 },
        { templateFile = "object/installation/faction_perk/turret/tower_lg.iff", x = 18.50, z = 0, y = -12, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1 },
