object_building_player_player_house_corellia_small_style_01_dark = object_building_player_shared_player_house_corellia_small_style_01_dark:new {
	...
	childObjects = {
		{templateFile = "object/tangible/sign/player/house_address_corellia.iff", x = -4.04, z = 2.4, y = 8.65, ox = 0, oy = 0.7071068, oz = 0, ow = 0.7071068, cellid = -1, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_player_structure.iff", x = -4.786, z = 0.74, y = -1.81, ox = 0, oy = 0.707107, oz = 0, ow = -0.707107, cellid = 1, containmentType = -1},
	},
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address_corellia.iff", x = -4.04, z = 2.4, y = 8.65, ox = 0, oy = 0.7071068, oz = 0, ow = 0.7071068, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
