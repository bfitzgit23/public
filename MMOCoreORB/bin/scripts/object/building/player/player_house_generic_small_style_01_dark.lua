object_building_player_player_house_generic_small_style_01_dark = object_building_player_shared_player_house_generic_small_style_01_dark:new {
	...
	childObjects = {
		{templateFile = "object/tangible/sign/player/house_address.iff", x = -4.14, z = 2.4, y = 8.26, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1},
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address.iff", x = -4.14, z = 2.4, y = 8.26, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
