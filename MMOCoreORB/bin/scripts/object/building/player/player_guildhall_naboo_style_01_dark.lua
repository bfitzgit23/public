object_building_player_player_guildhall_naboo_style_01_dark = object_building_player_shared_player_guildhall_naboo_style_01_dark:new {
	...
	childObjects = {
		{templateFile = "object/tangible/sign/player/house_address_naboo.iff", x = 4.5, z = 1.25, y = 21.7, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1},
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address_naboo.iff", x = 4.5, z = 1.25, y = 21.7, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
