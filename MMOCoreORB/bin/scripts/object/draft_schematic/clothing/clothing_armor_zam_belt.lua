...
object_draft_schematic_clothing_clothing_armor_zam_belt = object_draft_schematic_clothing_shared_clothing_armor_zam_belt:new {
   ...
   ingredientTitleNames = {"auxilary_coverage", "body", "liner", "padding", "reinforcement"},
   ingredientSlotType = {0, 0, 1, 3, 3},
   resourceTypes = {"metal", "hide", "object/tangible/component/clothing/shared_fiberplast_panel.iff", "object/tangible/component/clothing/shared_synthetic_cloth.iff", "object/tangible/component/clothing/shared_synthetic_cloth.iff"},
