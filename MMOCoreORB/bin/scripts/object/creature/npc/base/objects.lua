...
object_creature_npc_base_shared_gorax_base_male_grinch = SharedCreatureObjectTemplate:new {
	clientTemplateFileName = "object/swgemu/creature/npc/base/shared_gorax_base_male_grinch.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
}

ObjectTemplates:addClientTemplate(object_creature_npc_base_shared_gorax_base_male_grinch, "object/swgemu/creature/npc/base/shared_gorax_base_male_grinch.iff")
