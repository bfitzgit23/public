...
-- Infinity
object_tangible_dice_shared_eqp_forty_sided_dice_set = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/dice/shared_eqp_forty_sided_dice_set.iff"
}
ObjectTemplates:addClientTemplate(object_tangible_dice_shared_eqp_forty_sided_dice_set, "object/tangible/dice/shared_eqp_forty_sided_dice_set.iff")


object_tangible_dice_shared_eqp_fifty_sided_dice_set = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/dice/shared_eqp_fifty_sided_dice_set.iff"
}
ObjectTemplates:addClientTemplate(object_tangible_dice_shared_eqp_fifty_sided_dice_set, "object/tangible/dice/shared_eqp_fifty_sided_dice_set.iff")
