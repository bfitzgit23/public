...
includeFile("tangible/deed/player_house_deed/musty_house_deed_dark.lua")
...
-- dark houses
includeFile("tangible/deed/player_house_deed/generic_large_window_s02_deed_dark.lua")
