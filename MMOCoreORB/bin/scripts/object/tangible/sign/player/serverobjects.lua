...
-- Infinity added
includeFile("tangible/sign/player/efol_hanging_sign_01.lua")
includeFile("tangible/sign/player/house_address_halloween_sign.lua")
includeFile("tangible/sign/player/imperial_empire_day_2009_sign_hanging.lua")
includeFile("tangible/sign/player/rebel_remembrance_day_2009_sign_hanging.lua")
