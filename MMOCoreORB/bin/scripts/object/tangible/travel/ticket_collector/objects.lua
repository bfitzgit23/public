...
--[[
	...
	detailedDescription = "@travel:ticket_collector_description",

	gameObjectType = 16396,

	locationReservationRadius = 0,
	lookAtText = "@travel:ticket_collector_lookat",

	noBuildRadius = 0,

	objectName = "@travel:ticket_collector_name",
...
-- Infinity
object_tangible_travel_ticket_collector_shared_infinity_travel = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/travel/ticket_collector/shared_infinity_travel.iff"
}

ObjectTemplates:addClientTemplate(object_tangible_travel_ticket_collector_shared_infinity_travel, "object/tangible/travel/ticket_collector/shared_infinity_travel.iff")
