...
object_tangible_wearables_hat_shared_hat_fedora = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/wearables/hat/shared_hat_fedora__s01.iff"

}

ObjectTemplates:addClientTemplate(object_tangible_wearables_hat_shared_hat_fedora, "object/tangible/wearables/hat/shared_hat_fedora__s01.iff")
