...
-- Infinity
object_tangible_wearables_boots_shared_wod_nightsister_boots_s01 = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/wearables/boots/shared_wod_nightsister_boots_s01.iff"
}
ObjectTemplates:addClientTemplate(object_tangible_wearables_boots_shared_wod_nightsister_boots_s01, "object/tangible/wearables/boots/shared_wod_nightsister_boots_s01.iff")
